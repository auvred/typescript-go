...
function generateGoTest(test: GoTest, isServer: boolean): string {
    ...
    const imports = [`"github.com/microsoft/typescript-go/pkg/fourslash"`];
    ...
    if (/\bcore\./.test(commands)) {
        imports.unshift(`"github.com/microsoft/typescript-go/pkg/core"`);
    }
    if (/\bls\./.test(commands)) {
        imports.push(`"github.com/microsoft/typescript-go/pkg/ls"`);
    }
    if (/\blsutil\./.test(commands)) {
        imports.push(`"github.com/microsoft/typescript-go/pkg/ls/lsutil"`);
    }
    if (/\blsproto\./.test(commands)) {
        imports.push(`"github.com/microsoft/typescript-go/pkg/lsp/lsproto"`);
    }
    if (usesFourslashUtil(commands)) {
        imports.push(`. "github.com/microsoft/typescript-go/pkg/fourslash/tests/util"`);
    }
    imports.push(`"github.com/microsoft/typescript-go/pkg/testutil"`);
